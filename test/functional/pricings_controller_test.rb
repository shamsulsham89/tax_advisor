...
class PricingsControllerTest < ActionController::TestCase
  ...
  test "should create pricing" do
    assert_difference('Pricing.count') do
      post :create, pricing: { month: @pricing.month, rate: @pricing.rate, status: @pricing.status, time_period: @pricing.time_period }
    end
  ...
  test "should update pricing" do
    put :update, id: @pricing, pricing: { month: @pricing.month, rate: @pricing.rate, status: @pricing.status, time_period: @pricing.time_period }
    assert_redirected_to pricing_path(assigns(:pricing))
  end
